...
# species_temp={}
# species_temp[species_name[0]]='https://raw.githubusercontent.com/IEScoders/ObservingEarthWithData/nghianc/Analysis/fireants_temp.png'

# for i in range(1,len(species_name)):
#     species_temp.update({species_name[i]:'https://raw.githubusercontent.com/IEScoders/ObservingEarthWithData/nghianc/Analysis/fireants_temp.png'})

# species_rain={}
# species_rain[species_name[0]]='https://raw.githubusercontent.com/IEScoders/ObservingEarthWithData/nghianc/Analysis/fireants_rain.png'

# for i in range(1,len(species_name)):
#     species_rain.update({species_name[i]:'https://raw.githubusercontent.com/IEScoders/ObservingEarthWithData/nghianc/Analysis/fireants_rain.png'})
...
html.Div([
    ...
    className = "six columns"),html.H4(children='Contact Us', style={'color': 'green'}, #request to select
    className = "six columns")], className="row"),
            html.Div([
                dcc.Markdown(id='expert', #request to select
    className = "six columns"),html.Div([
            dcc.Markdown(id='contactus',children='''
    Team Name: IES Coders
    Members: Chase, Vincent, Su Jun, Nghiya, Utpal
    Web Address: www.iescoders.com
    ''', #request to select
    className = "six columns")
    ]
                )
